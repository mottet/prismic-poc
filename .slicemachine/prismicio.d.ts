 ...
 *
 */
interface ImageSliceCaptionPrimary {
    /**
     * Image field in *Image → Primary*
     *
     * - **Field Type**: Image
...
/**
 * caption variation for Image Slice
 *
 * - **API ID**: `caption`
 * - **Description**: `Image`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type ImageSliceCaption = prismicT.SharedSliceVariation<"caption", Simplify<ImageSliceCaptionPrimary>, never>;
/**
 * Slice variation for *Image*
 *
 */
type ImageSliceVariation = ImageSliceDefault | ImageSliceBanner | ImageSliceCaption;
/**
 * Image Shared Slice
 *
 * - **API ID**: `image`
